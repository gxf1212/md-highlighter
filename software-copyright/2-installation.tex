...
\midrule
NAMD / CHARMM & \lstinline|.rtf|、\lstinline|.str|、\lstinline|.inp|、\lstinline|.prm|、\lstinline|.par|、\lstinline|.pdb|、\lstinline|.psf| \\
Amber / AmberTools & \lstinline|.in|、\lstinline|leaprc.*|、\lstinline|.prmtop|、\lstinline|.parm7|、\lstinline|.inpcrd|、\lstinline|.rst7|、\lstinline|.prepin|、\lstinline|.prepi|、\lstinline|.frcmod|、\lstinline|.lib|、\lstinline|.off|、\lstinline|.ac|、\lstinline|.mc| \\
Gromacs & \lstinline|.gro|、\lstinline|.atp|、\lstinline|.arn|、\lstinline|.rtp|、\lstinline|.hdb|、\lstinline|.r2b|、\lstinline|.tdb|、\lstinline|.mtp|、\lstinline|.vsd| \\
小分子和辅助格式 & \lstinline|.mol2|、\lstinline|.sdf|、\lstinline|.mol|、\lstinline|.plumed.dat| \\
\bottomrule
\end{longtable}
\end{table}
